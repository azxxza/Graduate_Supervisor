...
function initBasicGrid() {
	jQuery('#basicGrid_div').datagrid({
		...
		url : '${pageContext.request.contextPath}/teacherBase/getRecentlyCourseListBySession?Date='
				+ new Date() + '',
		columns : [ [
		{field : 'r_c_id',hidden:true},
		{field : 'r_c_year',title : '学年',width : getWidth(0.35),halign : 'center'},
	 	{field : 'r_c_name',title : '课程名称',width : getWidth(0.35),halign : 'center'},
