...
function initBasicGrid() {
	jQuery('#basicGrid_div').datagrid({
		...
		url : '${pageContext.request.contextPath}/teacherBase/getRecentlyResearchListBySession?Date='
				+ new Date() + '',
		columns : [ [
		 {field : 'r_r_id',title : '年份',width : getWidth(0.1),align : 'center'},
		 {field : 'r_r_year',title : '年份',width : getWidth(0.1),align : 'center'},
	 	 {field : 'r_r_name',title : '教学\科研项目\成果\论著名称',width : getWidth(0.37),align : 'center'},
	 	 {field : 'r_r_type',title : '类型',width : getWidth(0.1),align : 'center'},
	 	 {field : 'r_r_remark',title : '备注',width : getWidth(0.1),align : 'center'},
