...
public class LogicVolunteerResult extends Model<LogicVolunteerResult> {
	...
	public static QueryResultBean<LogicVolunteerResult> findVolunteerResultByWorkId(
	...
	public static List<LogicVolunteerResult> findVolunteerResultBySId(String s_id) {
		String sql = "select * from " + LOGIC_VOLUNTEER_RESULT
				+ " where s_id = " + s_id;
